...
$requete = "UPDATE  fourbureaus SET nom = '$nom', description = '$description',ancien_prix = '$ancien_prix',prix = '$prix',image='$image', date_modification = '$date_modification' WHERE id='$id' ";
