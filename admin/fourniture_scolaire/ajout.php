...
try {
 ...
 $requete = "INSERT INTO fourScolaire(nom,description,prix,image,createur,categorie,date_creation,ancien_prix,couleur) VALUES ('$nom','$description','$prix','$image','$createur','$categorie','$date','$ancien','$couleur')";
