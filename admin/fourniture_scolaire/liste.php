...
$produitsfourScolaire = getAllProductsfourScolaire();
?>
...
<head>
    ...
    <title>Espace : fourScolaire</title>
...
?>
    ...
    <section class="home">
        <div class="text">Liste des fourniture Scolaire
...
<?php if (isset($_GET['erreur']) && $_GET['erreur'] == "duplicate") {
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                    $i = 0;
                     foreach ($produitsfourScolaire as $i=> $PN) {
                        $i++;
                        print '<tr>
                                <th scope="row">' . $i . '</th>
        ...
        <?php
            foreach($produitsfourScolaire as $index => $PN){?>
