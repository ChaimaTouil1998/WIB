...
try {
 ...
 $requete = "INSERT INTO nouveautés(nom,description,prix,image,createur,categorie,date_creation,ancien_prix,couleur) VALUES ('$nom','$description','$prix','$image','$createur','$categorie','$date','$ancien','$couleur')";
 ...
 $requete2 = "INSERT INTO stocksN(nouveauté,quantite,createur,date_creation) VALUES('$produit_id','$quantite','$createur','$date_creation')";
