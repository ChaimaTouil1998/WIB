...
?>
    ...
    <section class="home">
        <div class="text">Liste des produits
...
<?php if (isset($_GET['erreur']) && $_GET['erreur'] == "duplicate") {
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="ajout.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input  type="number" step="0.01" required name="prix" class="form-control" placeholder="Prix produit">
                            </div>
                            <div class="form-group">
        ...
        <?php
            foreach($produitsNouveautés as $index => $PN){?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="modifier.php" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" name="number" class="form-control" value="<?php echo $PN['prix']; ?>" placeholder="prix du nouveau produit">
                            </div>
                            <div class="form-group">
                                <input type="text" name="number" class="form-control" value="<?php echo $PN['ancien_prix']; ?>" placeholder="prix du nouveau produit">
                            </div>
                            <div class="form-group">
