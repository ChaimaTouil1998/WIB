...
$produitsPromotions = getAllProductsPromotions();
?>
...
?>
    ...
    <section class="home">
        <div class="text">Liste des produits en promotions
...
<?php if (isset($_GET['erreur']) && $_GET['erreur'] == "duplicate") {
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                    $i = 0;
                     foreach ($produitsPromotions as $i=> $PP) {
                        $i++;
                        print '<tr>
                                <th scope="row">' . $i . '</th>
                                ...
                                <td>' . $PP['prix'] . ' DT</td>
                                <td>' . $PP['ancien_prix'] . ' DT</td>
                                <td>' . $PP['categorie'] .' </td>
                                <td>
                                    <a data-toggle="modal" data-target="#editModal'.$PP['id'].'" class="btn btn-success">Modifier</a>
                                    <a onClick="return popUpDeleteCategorie()" href="supprimer.php?idpp=' . $PP['id'] . '" class="btn btn-danger">Supprimer</a>
                                </td>
                            </tr>';
                    }
                    ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Ajouter un produit en promotion</h5>
                    ...
                    <div class="modal-body">
                        <form action="ajout.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input  type="file"  required name="image" class="form-control" placeholder="Prix produit">
                            </div>
                            <div class="form-group">
        ...
        <?php
            foreach($produitsPromotions as $index => $PP){?>

   <!-- Modal Modifier-->
   <div class="modal fade" id="editModal<?php echo $PP['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLongTitle">Modifier un produit en promotion</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form action="modifier.php" method="post">
                            <input type="hidden" value="<?php echo $PP['id']; ?>" name="idpp" />
                            <div class="form-group">
                                <input type="text" name="nom" class="form-control" value="<?php echo $PP['nom']; ?>" placeholder="nom du nouveau produit">
                            </div>
                            <div class="form-group">
                                <input type="number" name="prix" class="form-control" value="<?php echo $PP['prix']; ?>" placeholder="prix du nouveau produit">
                            </div>
                            <div class="form-group">
                                <input type="number" name="ancien_prix" class="form-control" value="<?php echo $PP['ancien_prix']; ?>" placeholder="prix du nouveau produit">
                            </div>
                            <div class="form-group">
                                <input type="file" name="image" class="form-control" value="<?php echo $PP['image']; ?>" placeholder="image du produit...">
                            </div>

                            <div class="form-group">
                                <textarea type="text" name="description" class="form-control" placeholder="nouvelle description"><?php echo $PP['description']; ?> </textarea>
                            </div>
